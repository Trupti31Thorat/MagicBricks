...
public class Rent {
	...
	@When("user fills the contact form using data from")
	public void user_fills_contact_form_using_data_from(io.cucumber.datatable.DataTable dataTable) {
	    ...
	    String filePath = "C:\\Users\\SHANKARE\\eclipse-workspace\\MagicBricksRent\\src\\test\\resource\\ExcelData\\" + fileName;
