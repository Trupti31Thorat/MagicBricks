...
//----------------------------------------------------------Scenario 2 & 3 ---------------------------------------------------------------//
    ...
    public void waitForPopupsToSettle() {
        try {
            ...
            // Wait for up to 8 seconds for the close button to appear in DOM
            ...
            System.out.println("ℹ️ City popup did not appear within timeout. Proceeding.");
        } catch (Exception e) {
...
//	@FindBy(xpath = "//*[@id=\"details-container\"]/div[6]/button")
//	WebElement startNowBtn;
	...
	public void closePopupIfPresent() {
		...
		try {
	        ...
	        System.out.println("⚠️ Popup did not appear within wait time.");
	    } catch (Exception e) {
	...
	// And make sure you have this declared somewhere in your class:
