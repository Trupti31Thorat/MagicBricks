...
public class ExcelReader {
	...
	public static Map<String, String> getRowData(String SheetName, int rowNum) {
		...
		try (FileInputStream fis = new FileInputStream(
				"C:\\Users\\SHRDEOKA\\eclipse-workspace\\MagicBricksDemo\\src\\test\\resource\\TestData\\HomeInteriors.xlsx");
				Workbook workbook = new XSSFWorkbook(fis)) {

			Sheet sheet = workbook.getSheet(SheetName);
			Row header = sheet.getRow(0);
			Row row = sheet.getRow(rowNum);				//getting actual data row using rowNum we passed
