...
Feature: MagicBricks Buy Module Testing
  ...
  @MagicBricks @ReadytoMove @Positive
  ...
  @MagicBricks @FilterAndSort @Positive
  ...
  @MagicBricks @InvestmentHotspotValid @Positive
  ...
  @MagicBricks @InvestmentHotspotInvalid @Negative
  ...
  @MagicBricks @BuyVsRent @Positive
  ...
  @MagicBricks @TipsAndGuides @Positive
