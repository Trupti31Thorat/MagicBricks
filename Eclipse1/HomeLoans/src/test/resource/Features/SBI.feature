...
Scenario Outline: Verify selection of SBI Home Loan
  ...
  And the user selects the appropriate option for Is Token Amount Paid
...
Examples:
  | Loan Amount | Mobile Number | Property city #| Property City | Is Property Finalized? | Is Token Amount Paid?|
  | 5000000     | 9876543210    |mum            #| Pune,Maharashtra          | Yes                    |No        |
  | 3000000     | 9123456789    |mum            #| Mumbai,Maharashtra       | Yes                     |Yes        |